...
export const docs = await create.doc("docs", "packages/fuma-content/test/fixtures/generate-index", {"index.mdx": __fd_glob_0, "folder/test.mdx": __fd_glob_1, });
```
...
export const docs = await create.docLazy("docs", "packages/fuma-content/test/fixtures/generate-index-2", {"index.mdx": __fd_glob_0, "test/test.mdx": __fd_glob_1, }, {"index.mdx": () => import("../generate-index-2/index.mdx?collection=docs&workspace=test"), "test/test.mdx": () => import("../generate-index-2/test/test.mdx?collection=docs&workspace=test"), });
```
...
}>(Config, {"configPath":"packages/fuma-content/test/fixtures/config.ts","environment":"test","outDir":"packages/fuma-content/test/fixtures/test"}, {"doc":{"passthroughs":["extractedReferences"]}});
```
