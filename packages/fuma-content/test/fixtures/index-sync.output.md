...
export const blogs = await create.doc("blogs", "packages/fuma-content/test/fixtures/generate-index", {"index.mdx": __fd_glob_2, "folder/test.mdx": __fd_glob_3, });
```
...
}>(Config, {"configPath":"packages/fuma-content/test/fixtures/config.ts","environment":"test","outDir":"packages/fuma-content/test/fixtures"}, {"doc":{"passthroughs":["extractedReferences","lastModified"]}});
```
