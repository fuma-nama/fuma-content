...
import { type LinkReference } from "fuma-content/collections/mdx";
export const blogs = mdxStoreDynamic<typeof Config,"blogs",unknown & { /** extracted link references (e.g. hrefs, paths), useful for analyzing relationships between pages. */ _linkReferences: LinkReference[] }>(Config,{"configPath":"packages/fuma-content/test/fixtures/config.ts","outDir":"packages/fuma-content/test/fixtures","cwd":""},"blogs","packages/fuma-content/test/fixtures/generate-index",{"index.mdx": __0,"folder/test.mdx": __1,},_jsx_runtime);
```